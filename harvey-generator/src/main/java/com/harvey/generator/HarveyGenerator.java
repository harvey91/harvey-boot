...
public class HarveyGenerator {
    ...
    private final static String OUTPUT_DIR = "G://Development//Workspace//harvey-boot//harvey-system//harvey-system-service";
...
//							.fileOverride() // 覆盖已生成文件
                ...
                .strategyConfig(builder -> {
                    builder.addInclude("sys_job_log") // 设置需要生成的表名
